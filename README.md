# Инструкция по установке информационной системы "Gao's Studio"
...
6. Скачать файл `rec_studio`
7. Создать базу данных с названием `rec_studio` и кодировкой `utf8_general_ci`
...
4. Создать базу данных MySQL на хостинге и импортировать файл `azimutsql`
5. Заменить данные в файле `DB.php` (`host_user`, `password`, `dbname`) на данные хостинга
